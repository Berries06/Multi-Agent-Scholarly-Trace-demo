...
# 启动命令：python -m streamlit run scripts/实验台/gliner_entity_lab.py --global.developmentMode false --server.address 127.0.0.1 --server.port 8502 --server.baseUrlPath AgentDemo/lab/gliner
